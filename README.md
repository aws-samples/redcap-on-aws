...
| cronSecret               | Base string to create a hashed secret to allow access to https:<your_domain>/cron.php. **Required** — must be set explicitly in every stage configuration.                                                                                            | String            | —                                         |
